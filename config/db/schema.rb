...
ActiveRecord::Schema.define(version: 20170530191204) do
  ...
  create_table "social_entity_lookups", force: :cascade do |t|
    t.string  "provider"
    t.text    "url"
    t.integer "entity_id"
  end

  add_index "social_entity_lookups", ["entity_id"], name: "index_social_entity_lookups_on_entity_id", using: :btree
  add_index "social_entity_lookups", ["provider", "url"], name: "index_social_entity_lookups_on_provider_and_url", using: :btree
